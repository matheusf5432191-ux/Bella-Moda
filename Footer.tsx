      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm">
              Moda feminina com estilo e qualidade. Vista-se com elegância todos os dias.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="#" className="hover:text-pink-400 transition-colors">Entregas</a></li>
              <li><a href="#" className="hover:text-pink-400 transition-colors">Trocas e Devoluções</a></li>
              <li><a href="#" className="hover:text-pink-400 transition-colors">Formas de Pagamento</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm">
            © 2024 Bella Moda. Todos os direitos reservados.
          </p>
